...
export const PROVIDERS: Record<string, ProviderMeta> = {
  ...
  openai: {
    ...
    icon: "brain",
    color: "142 71% 45%",
    description: "GPT-5.5, GPT-5.5-instant, o3, and DALL·E models",
  ...
  anthropic: {
    ...
    icon: "sparkles",
    color: "25 95% 53%",
    description: "Claude 4.8 Opus, Claude Sonnet 4, and Haiku models",
  ...
  gemini: {
    ...
    icon: "hexagon",
    color: "250 85% 60%",
    description: "Gemini 3.1 Pro, 3.5 Flash, and Lite models",
  ...
  groq: {
    ...
    icon: "zap",
    color: "185 100% 50%",
    description: "Ultra-fast LPU inference for Llama 4, Mixtral, and Gemma",
  ...
  mistral: {
    ...
    icon: "wind",
    color: "340 82% 60%",
    description: "Mistral Medium 3.5, Large, Small 4, and Codestral models",
